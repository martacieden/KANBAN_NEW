    ...
    <TooltipProvider>
      <div className="flex flex-col h-full w-full relative kanban-board-container">
        ...
        <div className="px-2 pt-2 pb-2">
          ...
          {/* Quick Filter Pills */}
          <div className="px-6 flex flex-wrap gap-0.5 mb-2 justify-between">

            <button
              onClick={() => toggleQuickFilter('assignedToMe')}
              className={`px-1.5 py-0.5 rounded-full text-sm font-medium transition-colors flex items-center gap-1 ${
